...
if("TRUE" STREQUAL "TRUE")
  set(gaitech_edu_SOURCE_PREFIX /home/turtlebot/project_ws/src/gaitech_edu)
  set(gaitech_edu_DEVEL_PREFIX /home/turtlebot/project_ws/devel)
  ...
  set(gaitech_edu_INSTALL_PREFIX /home/turtlebot/project_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gaitech_edu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ros <ros@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gaitech_edu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/project_ws/src/gaitech_edu/${idir}'.  Ask the maintainer 'ros <ros@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gaitech_edu_dep}_FOUND)
      find_package(${gaitech_edu_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gaitech_edu_dep} REQUIRED ${depend_list})
  endif()
